...
class SuperMacd(IStrategy):
    ...
    macd_fast_period = IntParameter(low=10, high=20, default=12, space='sell', optimize=True)
    macd_slow_period= IntParameter(low=20, high=35, default=26, space='sell', optimize=True)
