...
# --------------------------------
# freqtrade hyperopt -c  user_data/backtest-config.json  --epochs 1000 --spaces buy stoploss roi --hyperopt-loss SharpeHyperOptLossDaily --timeframe 1d -s ADXMomentumHopt

class ADXMomentumHopt(IStrategy):
    """

    author@: Gert Wohlgemuth
    Hyperopt code by: DutchCryptoDad (2022)
